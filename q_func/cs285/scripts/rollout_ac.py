...
class AC_Trainer(object):
    ...
    def __init__(self, params):
        ...
        self.rl_trainer.agent.critic.critic_network.load_state_dict(torch.load(critic_checkpoint_path))

        self.rl_trainer.agent.critic.critic_network.eval()
...
def main():
    ...
    parser.add_argument('--checkpoint_idx', type=str, default='110')

    parser.add_argument('--save_params', action='store_true')

    parser.add_argument('--rollout_path', type=str, default='ac_Ant-v4')
