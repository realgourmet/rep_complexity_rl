...
env_names=("Hopper-v4" "HalfCheetah-v4" "InvertedPendulum-v4" "Walker2d-v4")
...
for env_name in "${env_names[@]}"; do
  ...
  python cs285/scripts/rollout_ac.py --env_name "$env_name" --ep_len 200 --discount 0.95 --scalar_log_freq 1 -n 10 -l 3 -s 128 -b 30000 -eb 1500 -lr 0.001 --exp_name "ac_$env_name" --rollout_path "ac_$env_name"
